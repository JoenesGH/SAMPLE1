...
function getEarnings(year){
    ...
    $.ajax({
        ...
        document.getElementById('earningsTitle').innerHTML = "Sales (" + response.earningsYear +")";
...
function loadPaymentMethodChart(year){
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var cashAndReserved = response.cashAndReserved;

            if(response.status === 1) {
                if((cash === 0 && reserved === 0 && cashAndReserved === 0)) {
                  ...
                  var paymentMethodData = [{
                    ...
                    value: cashAndReserved,
                    color: "#333",
                    highlight: "pink",
                    label: "Cash and Reserved"
                  }];
                }
            } 
