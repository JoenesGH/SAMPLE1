...
class Transaction_reserve extends CI_Model {
    ...
    public function getAll($orderBy, $orderFormat, $start, $limit) {
            $this->db->select('transactions.transId,
                               transactions.ref,
                               transactions.totalMoneySpent, 
                               transactions.status, 
                               transactions.pick_date, 
                               transactions.lastUpdated, 
                               transactions.amountTendered, 
                               transactions.changeDue,
    ...
    public function transaction_cancel($ref){
    ...
    public function edit($itemId, $Status, $custName , $mobile){
       $data = ['status'=>$Status,'cust_name'=>$custName,'cust_phone'=>$mobile];
       
       $this->db->where('ref', $itemId);
