...
class Customer_management extends CI_Model{
     ...
     * @return boolean
     */
    public function add($f_name, $l_name, $email, $mobile1, $mobile2, $vcard){
        $data = ['first_name'=>$f_name, 'last_name'=>$l_name, 'email'=>$email, 'mobile1'=>$mobile1, 'mobile2'=>$mobile2, 'vcard'=>$vcard];
        ...
        $this->db->insert('walkin_register', $data);
    ...
    */
    ...
    public function update_last_login($admin_id){
        ...
        $this->db->update('walkin_register');
    ...
    */
    ...
    public function getAll($orderBy = "first_name", $orderFormat = "ASC", $start = 0, $limit = ""){
        $this->db->select('id, first_name, last_name, email, role, mobile1, mobile2, vcard, pcard, created_on, last_login, account_status, deleted');
     //   $this->db->where("id != ", $_SESSION['admin_id']);
    //   $this->db->where("email != ", "joenes1214@gmail.com");//added to prevent people from removing the demo admin account
    ...
    */ 
    public function suspend($admin_id, $new_status){       
        $this->db->where('id', $admin_id);
        $this->db->update('walkin_register', ['account_status'=>$new_status]);
    ...
    */
    public function delete($admin_id, $new_value){       
        $this->db->where('id', $admin_id);
        $this->db->update('walkin_register', ['deleted'=>$new_value]);
    ...
    */
    ...
    public function adminSearch($value){
        $q = "SELECT * FROM walkin_register WHERE 
    ...
    */
    ...
    public function update($admin_id, $first_name, $last_name, $email, $mobile1, $mobile2, $role){
        ...
        $this->db->update('walkin_register', $data);
