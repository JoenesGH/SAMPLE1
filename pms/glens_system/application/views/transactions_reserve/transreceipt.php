...
<div id="transReceiptToPrint">
    <div class="row">
        <div class="col-xs-12 text-center text-uppercase">
            ...
            <b>Glenn's, Pharmacy</b>
            <p>Guanzon St, Kabankalan City Neg. Occ. 611 </p>
            <p>Mary Glen F. Gargantiel - Proprietness</p>
            <div>VAT Reg. TIN: 171-990-100-000</div>
        </div>
    </div>
    ...
    <div class="row margin-top-5">
        <div class="col-xs-12">
            <b>Pickup Date: <?=isset($_pick) ? str_replace("_", " ", $_pick) : ""?></b>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12">
