                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <div style="font-size:100px">
                                <h1><img src="<?=base_url()?>public/images/logoup.png" alt="PointUp-logo" height="150px"></h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center" style="color:white">
                           <a style="#808080"> Designed and Developed by</a> <a href="#" target='_blank' class="text-primary">P<img src="<?=base_url()?>public/images/logoup.png" alt="1410-logo" height="15px">intUp</a> (2018)
                        </div>
                    </div>
                </div>
            </div>
