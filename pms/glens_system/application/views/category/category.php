            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2 form-inline form-group-sm">
                        <button class="btn btn-primary btn-sm" id='createItem'>Add New Category</button>
                    </div>
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        ...
                        <input type="search" id="itemSearch" class="form-control" placeholder="Search Category">
                    </div>
                </div>
            </div>
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                ...
                                <input type="text" id="itemName" name="itemName" placeholder="Category Name" maxlength="80"
                ...
                <form role="form">
                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group-sm">
                            <label for="itemNameEdit">Category Name</label>
                            <input type="text" id="itemNameEdit" placeholder="Category Name" autofocus class="form-control checkField">
...
<!--end of modal-->
<script src="<?=base_url()?>public/js/cats.js"></script>