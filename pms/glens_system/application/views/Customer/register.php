              ...
              <div class="login-panel panel panel-success">
                  ...
                  if($error_msg){
                   ...
                   ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('customer/register_user'); ?>">
                          <fieldset>
                      ...
                      <center><b>Already registered ?</b> <br></b><a href="<?php echo base_url('customer/login_view'); ?>">Login here</a></center><!--for centered text-->
                  </div>
              </div>
          </div>
      </div>
