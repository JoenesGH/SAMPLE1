...
if(isset($items) && !empty($items)){    
    foreach($items as $get){
        ...
        $current_items_unit[$get->code] = $get->unit;
    }
}
?>
...
<script>
    ...
    var currentItems_unit = <?=json_encode($current_items_unit)?>;
</script>
                ...
                <div class="col-sm-12" id="salesTransFormDiv">
                    <div class="well">
                        <form name="salesTransForm" id="salesTransForm" role="form">
                            ...
                            <br>
                            <span id="warning-prescription"></span>
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group-sm hidden">
                                            ...
                                            <input type="text" min="0" id="modeOfPayment" class="form-control" value="Cash">
...
<div class="row hidden" id="divToClone">
    ...
    <div class="col-sm-2 form-group-sm hidden prescriptionDiv">
        <label>Prescription</label>
        <span class="form-control prescription">Select Stock</span>
    </div>
...
<!--
<div id="pop_up_prescription" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">            
             <h1 class="text-center">THE SELECTED PRODUCT</h1>
             <p class="text-center">REQUIRED PRESCRIPTION SLIP</p>               
        </div>
    </div>
</div>
-->
