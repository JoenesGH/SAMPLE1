...
<div class="row hidden-print">
    <div class="col-sm-12">
        <div class="pwell">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="btn btn-primary btn-sm" data-target='#addNewAdminModal' data-toggle='modal'><i class="ion-android-person-add"></i> 
                        New Customer
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id='addNewAdminForm' name='addNewAdminForm' role='form'>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group-sm col-sm-6">
                            <label for='vcard' class="control-label">Value Card</label>
                            <input type="vcard" id='vcard' class="form-control checkField" placeholder="Value Card">
                            <span class="help-block errMsg" id="vcardErr"></span>
                        </div>
            ...
            <div class="modal-footer">
                <button type="reset" form="addNewAdminForm" class="btn btn-warning pull-left">Clear Form</button>
...
<script src="<?=base_url()?>public/js/customer_managements.js"></script>