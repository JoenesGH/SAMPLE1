...
class Search_supplier extends CI_Controller{
    protected $value;
    ...
    */
    ...
    public function itemSearch(){
        $data['allItems'] = $this->supp->itemsearch($this->value);
        $data['sn'] = 1;
        $data['cum_total'] = $this->supp->getItemsCumTotal();
        
        $json['itemsListTable'] = $data['allItems'] ? $this->load->view('supps/suppslisttable', $data, TRUE) : "No match found";
