...
<?php 
    ...
    echo form_open(site_url().'shop/changeuser/', $fattr); ?>
    ...
    <div class="form-group">
      <?php echo form_input(array('name'=>'mobile', 'id'=> 'mobile', 'placeholder'=>'+63', 'class'=>'form-control', 'value'=> set_value('mobile', $groups->mobile))); ?>
      <?php echo form_error('mobile');?>
    </div>
    <div class="form-group">
      <?php echo form_input(array('name'=>'address', 'id'=> 'address', 'placeholder'=>'Address', 'class'=>'form-control', 'value'=> set_value('address', $groups->address))); ?>
