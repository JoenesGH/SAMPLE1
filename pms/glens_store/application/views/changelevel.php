<div class="col-lg-4 col-lg-offset-4">
    ...
    <?php $fattr = array('class' => 'form-signin');
         echo form_open(site_url().'shop/changelevel/', $fattr); ?>
    ...
    <a href="<?php echo site_url().'shop/users/';?>"><button type="button" class="btn btn-default btn-lg btn-block">Cancel</button></a>
    <?php echo form_close(); ?>
</div>