...
class User_model extends CI_Model {
    ...
    {   
        $this->db->where('id', $post['user_id']);
        $this->db->update('users', array('password' => $post['password'], 'email' => $post['email'], 'mobile' => $post['mobile'], 'address' => $post['address'], 'first_name' => $post['firstname'], 'last_name' => $post['lastname'])); 
        $success = $this->db->affected_rows(); 
